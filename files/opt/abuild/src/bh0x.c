...
/* TODO: make the source not terrible */
...
int main(int argc, char** argv)
{
	...
	char* stage1file = calloc(strlen(argv[2]) + strlen(stage1fname) + 1, sizeof(char));
	...
	char* stage2file = calloc(strlen(argv[2]) + strlen(stage2fname) + 1, sizeof(char));
...
keep:
	...
	if(512 == strlen(bh0stage2)) goto keep;
	close(output2);
